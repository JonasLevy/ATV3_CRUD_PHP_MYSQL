          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?= $prod['estoque_prod'] ?></td>
                <td><?= $prod['preço_prod'] ?></td>
                <td><?= $prod['data_cadastro_prod'] ?></td>
                <td>
        ...
        <div class="modal-content">
          ...
          <form action="insert.php" method="post">
            <div class="modal-body">
              <div class="row g-3">
                <div class="col">
                  <input type="text" class="form-control" placeholder="Nome" aria-label="Last name" name="nome_prod" required>
                </div>
                <div class="col" style="display: none;">
                  <input type="text" class="form-control" placeholder="Produtos" aria-label="Last name" name="action" value="produtos"  required>
                </div>
              </div>

              <div class="row g-3 my-2">
                <div class="col ">
                  <input type="text" class="form-control" placeholder="Estoque" aria-label="First name" name="estoque_prod" required>
                </div>
                <div class="col ">
                  <input type="text" class="form-control" placeholder="Preço" aria-label="Last name" name="preço_prod" required>
                </div>
              </div>
            </div>
            <div class="modal-footer">
